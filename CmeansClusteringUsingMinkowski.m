...
while max(abs(m1-m)) > 0.001
    ...
    m=m1;
     if c==2
         for j = 1:15000
            distance1(j) =  pdist2(testset1(j,1:4),m(1,:),'minkowski');
         end 

        for j = 1:15000
            distance2(j) =  pdist2(testset1(j,1:4),m(2,:),'minkowski');
        end
        for j=1:15000
    ...
    elseif c==3
        ...
        for j = 1:15000
            distance3(j) = pdist2(testset1(j,1:4),m(3,:),'minkowski');
        end
        for j=1:15000
    ...
    elseif c==4
        ...
        for j = 1:15000
            distance4(j) =  pdist2(testset1(j,1:4),m(4,:),'minkowski');
        end
        for j=1:15000
        ...
        for j = 1:15000
            distance5(j) =  pdist2(testset1(j,1:4),m(5,:),'minkowski');
        end
        for j=1:15000
